...
namespace Microsoft.CodeAnalysis.Serialization
{
    ...
    {
        public ChecksumWithChildren(SerializationKind kind, params object[] children)
        {
        ...
        private static Checksum CreateChecksum(SerializationKind kind, object[] children)
        {
